...
<?php $__env->startSection('title', 'Registro Doctor'); ?>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 text-center">
                <img src="<?php echo e(asset('images/icon-5.png')); ?>" alt="Icono Doctor" class="img-fluid mb-3" style="max-width: 120px;">
            ...
            <div class="col-lg-6">
                <div class="card shadow p-4 border-0">
                    ...
                    <form action="<?php echo e(route('registrar.doctor')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\YaYaG\Desktop\patli\patli\resources\views/register/registerDoctor.blade.php ENDPATH**/ ?>